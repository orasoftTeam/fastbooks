...
public class StatementController implements Serializable{
    ...
    private @Getter @Setter SimpleDateFormat sdf = new SimpleDateFormat("MM/dd/yyyy");
    private @Getter @Setter DateFormat sd = new SimpleDateFormat("EEE MMM dd HH:mm:ss zzz yyyy", Locale.US);
    @EJB
    ...
    private @Getter @Setter FbStatement statement = null;
